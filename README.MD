...
ad.secondary
```
See application-dev.yml for an example of how these can be configured.
...
Authentication will be performed using the credentials provided in `environment.ts`. 
